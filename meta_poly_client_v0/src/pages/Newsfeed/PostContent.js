...
class LikeButton extends React.Component {
  ...
  render() {
    let buttonText = this.state.liked? <i className="mdi mdi-heart text-danger" /> : <i className="mdi mdi-heart" />;
    return (
      <span onClick={this.handleClick}> {buttonText} </span>
     );
  }
}
          ...
          <div className="card-body pb-1">
            ...
            <div className="mt-1 mb-1">
              <a href="/#>" className="btn btn-sm btn-link text-muted ps-0">
                <a href="/#>" className="btn btn-sm btn-link text-muted p-0 m-1" id="Likebtn"><i className="mdi mdi-heart " /></a>
                {
