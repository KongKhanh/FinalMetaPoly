export default function ChatCenterSide() {
            ...
            <div className="col-xxl-6 col-xl-12 order-xl-2">
                <div className="card">
                    <div className="card-body">
                        <ul className="conversation-list" data-simplebar="init" style={{maxHeight: '537px'}}>
                            <div className="simplebar-wrapper" style={{margin: '0px -15px'}}>
                                <div className="simplebar-height-auto-observer-wrapper">
                                    <div className="simplebar-height-auto-observer" /></div>
                                    <div className="simplebar-mask"><div className="simplebar-offset" style={{right: '0px', bottom: '0px'}}>
                                    <div className="simplebar-content-wrapper" style={{height: 'auto', overflow: 'hidden scroll'}}>
                                        <div className="simplebar-content" style={{padding: '0px 15px'}}>
                                    ...
                                    <li className="clearfix odd">
                                        ...
                                        <div className="card mt-2 mb-1 shadow-none border text-start">
                                            ...
                                            <div className="row align-items-center">
                                                ...
                                                <a href="/#" className="text-muted fw-bold">Hyper-admin-design.zip</a>
                                    ...
                                    </div></div></div></div><div className="simplebar-placeholder" style={{width: '688px', height: '911px'}} /></div><div className="simplebar-track simplebar-horizontal" style={{visibility: 'hidden'}}><div className="simplebar-scrollbar" style={{width: '0px', display: 'none'}} /></div><div className="simplebar-track simplebar-vertical" style={{visibility: 'visible'}}><div className="simplebar-scrollbar" style={{height: '316px', transform: 'translate3d(0px, 0px, 0px)', display: 'block'}} /></div></ul>
                        <div className="row">
                            <div className="col">
